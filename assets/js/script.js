...
// ========== same height of review boxes ======

document.addEventListener("DOMContentLoaded", function () {
  function setEqualHeight() {
    if (window.innerWidth > 768) {
      var reviewBoxes = document.querySelectorAll(".ps-review-box");
      var maxHeight = 0;
      ...
      // Loop through all the review boxes to find the tallest one
      reviewBoxes.forEach(function (box) {
      ...
      // Set all the boxes to the height of the tallest one
      reviewBoxes.forEach(function (box) {
  ...
  // Run the function on DOM load
  setEqualHeight();

  // Run the function on window resize to dynamically adjust heights
...
var ResizingWithScroll = (function (current_scroll_position, is_scroll) {
  ...
  (function () {
    ...
    if (
      window.location.host.includes("shopifypreview.com") ||
    ...
    if (!window.OptiMonkRegistry) {
      ...
      OptiMonkEmbedded.isDebug = function () {
        return (
          window.location.search.toLowerCase().includes("omdebug") ||
          sessionStorage.getItem("omdebug") !== null
        );
      };
      ...
      window.OptiMonkRegistry = {
        ...
        jfJsScriptUrl:
          "https://gs-cdn.optimonk.com/jfclientsdk/latest/jfclientsdk.min.js?ts=15",
        ...
        fileVersions: {
          "embeddedIntlTelInput.min.js":
            "embeddedIntlTelInput.min.js?v=5617f1489f",
          ...
          "shopify-preload.min.js": "shopify-preload.min.js?v=a60f51c8e8",
          "shoprenter-preload.min.js": "shoprenter-preload.min.js?v=6a401c77e0",
          "swiper.js": "swiper.1f9cdb4a.js",
          "om.base.css": "om.base.d4bb7b2f80504e434727.css",
        },
        externalValidators: {},
        trackJsApiKey: "",
        getAssetUrlFor,
